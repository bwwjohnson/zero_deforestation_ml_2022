# -*- coding: utf-8 -*-
"""Copy of transfer_learning_tutorial.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1QpRIRoRJrz_cDOhaUbz_dg2KsN6o9XBu
"""
...
data_dir = '/content/drive/MyDrive/hymenoptera_data'#'data/hymenoptera_data'
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'train':
              ...
              train_acc = np.append(train_acc,epoch_acc.item())
            if phase == 'val':
              val_loss = np.append(val_loss,epoch_loss)
              val_acc = np.append(val_acc,epoch_acc.item())
            # deep copy the model
